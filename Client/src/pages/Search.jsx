...
export default function Search() {
  ...
  useEffect(() => {
    ...
    if (searchItemFromUrl || sortFromUrl || categoryFromUrl) {
      setSidebarData({
        ...sidebarData,
    ...
    <div className='flex flex-col md:flex-row'>
      <div className='p-7 border-b md:border-r md:min-h-screen border-gray-500'>
        ...
        <option value='Large Language Model'>Large Language Model</option>
          ...
          <Button type='submit' outline className='text-white italic bg-gradient-to-r from-green-400 to-black hover:bg-gradient-to-l w-full mt-5'>
            Apply Filters
          </Button>
        </form>
      </div>
